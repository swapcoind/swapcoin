...
Only requiring some minor changes is swap.cpp.
...
Changes to swap.cpp
----------------------
swap.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
