    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Swap Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Swap address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and swap: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Swap Core"), this);
    aboutAction->setStatusTip(tr("Show information about Swap Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Swap Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Swap addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Swap addresses"));
    ...
    openAction->setStatusTip(tr("Open a swap: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Swap Core help message to get a list with possible Swap Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Swap Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Swap network", "", count));
}
...
{
    QString strTitle = tr("Swap Core"); // default title
