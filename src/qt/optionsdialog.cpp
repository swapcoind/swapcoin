    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SWAP-light"), QVariant("light"));
    ui->theme->addItem(QString("SWAP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SWAP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SWAP-traditional"), QVariant("trad"));
