    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Swap Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Swap Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  swap-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Swap in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SWAP, 0.1 SWAP, 1 SWAP and 10 SWAP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://swappay.atlassian.net/wiki/display/DOC/PrivateSend\">https://swappay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Swap Core is shutting down...") + "<br /><br />" +
