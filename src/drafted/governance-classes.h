 ...
 *
 *   // network
 *   CSwapNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.swap.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSwapNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SwapNetwork
// //   -- signature requirements : Key1(User)
// class CSwapNetworkVariable : public CGovernanceObject
// {
// private:
