...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SwapNetwork") type = SwapNetwork;
    if(strType == "SwapNetworkVariable") type = SwapNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SwapNetwork) s = "SwapNetwork";
    if(type == SwapNetworkVariable) s = "SwapNetworkVariable";
